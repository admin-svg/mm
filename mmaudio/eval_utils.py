...
class ModelConfig:
    ...
    mode: str
    synchformer_ckpt: Path = Path('./root/ext_weights/synchformer_state_dict.pth')
...
small_16k = ModelConfig(model_name='small_16k',
                        model_path=Path('./root/weights/mmaudio_small_16k.pth'),
                        vae_path=Path('./root/ext_weights/v1-16.pth'),
                        bigvgan_16k_path=Path('./root/ext_weights/best_netG.pt'),
                        mode='16k')
small_44k = ModelConfig(model_name='small_44k',
                        model_path=Path('./root/weights/mmaudio_small_44k.pth'),
                        vae_path=Path('./root/ext_weights/v1-44.pth'),
                        bigvgan_16k_path=None,
                        mode='44k')
medium_44k = ModelConfig(model_name='medium_44k',
                         model_path=Path('./root/weights/mmaudio_medium_44k.pth'),
                         vae_path=Path('./root/ext_weights/v1-44.pth'),
                         bigvgan_16k_path=None,
                         mode='44k')
large_44k = ModelConfig(model_name='large_44k',
                        model_path=Path('./root/weights/mmaudio_large_44k.pth'),
                        vae_path=Path('./root/ext_weights/v1-44.pth'),
                        bigvgan_16k_path=None,
                        mode='44k')
large_44k_v2 = ModelConfig(model_name='large_44k_v2',
                           model_path=Path('./root/weights/mmaudio_large_44k_v2.pth'),
                           vae_path=Path('./root/ext_weights/v1-44.pth'),
                           bigvgan_16k_path=None,
                           mode='44k')
